...
|---|---|---|---|
| 1 | `frame-assembly.mp4` | Hero background + Motion Showcase reel 1 | Supplied |
| 2 | `model-designer.mp4` | Campaign full-screen background + Motion Showcase reel 2 | Supplied |
| 3 | `eye-testing.mp4` | EyeQ precision-technology panel (right side) | Needed |
| 4 | `store-interior.mp4` | Store Locator walkthrough band (wide 21:9 banner) | Needed |
| 5 | `product-macro.mp4` | Detail Reel section, between Collection and Campaign | Needed |
| 6 | `customer-fitting.mp4` | Book Band booking section background (dimmed behind text) | Needed |
| 7 | `logo-reveal.mp4` | Intro overlay, optional soft layer behind the wordmark | Optional |
